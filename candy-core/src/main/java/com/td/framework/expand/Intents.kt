...
inline fun <reified T : Activity> Activity.launcherActivity(vararg params: Pair<String, Any>) {
    AnkoInternals.internalStartActivity(this, T::class.java, params)
...
inline fun <reified T : Activity> Fragment.launcherActivity(vararg params: Pair<String, Any?>) {
    AnkoInternals.internalStartActivity(activity as Context, T::class.java, params)
    JumpAnimUtils.jumpTo(activity)

}

inline fun <reified T : Activity> Activity.launcherActivityForResult(requestCode: Int, vararg params: Pair<String, Any>) {
    AnkoInternals.internalStartActivityForResult(this, T::class.java, requestCode, params)
    JumpAnimUtils.jumpTo(this)

}

inline fun <reified T : Activity> Fragment.launcherActivityForResult(requestCode: Int, vararg params: Pair<String, Any>) {
    startActivityForResult(AnkoInternals.createIntent(act!!, T::class.java, params), requestCode)
    JumpAnimUtils.jumpTo(activity)

}

inline fun <reified T : Service> Context.launcherService(vararg params: Pair<String, Any>) {
    AnkoInternals.internalStartService(this, T::class.java, params)
}


inline fun <reified T : Service> Fragment.launcherService(vararg params: Pair<String, Any>) {
