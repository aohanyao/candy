...
public class PersistentCookieStore {
     ...
     * @throws Exception
     */
    public void add(HttpUrl url, Cookie cookie) throws Exception {
        ...
        String join = TextUtils.join(",", cookies.get(host).keySet());
        prefsWriter.putString(host, join);
        String value = encodeCookie(new SerializableOkHttpCookies(cookie));
        prefsWriter.putString(name, value);
        prefsWriter.apply();
    }
