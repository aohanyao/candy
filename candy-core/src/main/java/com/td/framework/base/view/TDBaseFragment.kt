...
/**
 * Created by jc on 2016/12/15 0015.
 *
 * 基类 Fragment
 */
...
open class TDBaseFragment : RxFragment() {
     ...
     */
    @SafeVarargs
    protected fun startActivityFromSharedElementsTransition(toClass: Class<*>, intentData: Serializable?, vararg sharedElements: Pair<View, String>) {
    ...
    protected fun <T> getCompose(): FlowableTransformer<T, T> {
        return FlowableTransformer { observable ->
            observable.subscribeOn(Schedulers.io())
                    ...
                    .compose<T>(bindUntilEvent<T>(FragmentEvent.DESTROY))
        }
    }
}
