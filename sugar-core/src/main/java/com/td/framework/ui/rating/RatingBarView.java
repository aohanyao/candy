package com.td.framework.ui.rating;
...
public class RatingBarView extends LinearLayout {
    ...
    private ImageView getStarImageView(Context context, AttributeSet attrs) {
        ...
        ViewGroup.MarginLayoutParams para = new ViewGroup.MarginLayoutParams(Math.round(starImageSize), Math.round(starImageSize));
        para.rightMargin = DensityUtils.dp2px(context, 12f);
        imageView.setLayoutParams(para);
//        imageView.setPadding(0, 0, DensityUtils.dp2px(context, 12f), 0);
